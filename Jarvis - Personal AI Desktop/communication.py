...
def send_whatsapp_message():
    ...
    phone_number = int(input("Enter phone number (with country code, e.g., +11234567890): "))
...
TWILIO_PHONE_NUMBER = "+18454421463"   #for refernce number 
...
def make_phone_call():
    ...
    if not twilio_available:
        say("Phone calling feature is not available. Twilio is not installed.")
        return

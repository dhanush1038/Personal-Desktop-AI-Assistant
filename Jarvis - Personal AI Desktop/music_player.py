...
# List of songs
songs = [
    r"E:\content\Maadeva-Sanjith-Hegde-Hanumankind-Charan-Raj.mp3",
    r"E:\content\WhatsApp Audio 2025-01-27 at 4.57.31 PM.mpeg",
    r"E:\content\bad-boys_4Xmz38h3.mp3",
    r"E:\content\Aarambha Aarambha.mp3",
    r"E:\content\WhatsApp Audio 2025-01-27 at 4.38.59 PM.mpeg",
]
...
def play_next_song():
    ...
    if not pygame_available:
        print("Music player not available - pygame not installed.")
        return
...
def stop_song():
    ...
    if pygame_available:
        ...
        print("Cannot stop music - pygame not available.")
